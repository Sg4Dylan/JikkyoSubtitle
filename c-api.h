...
SHERPA_ONNX_API int32_t SherpaOnnxWriteWaveToBuffer(const float *samples,
                                                    int32_t n,
                                                    int32_t sample_rate,
                                                    char *buffer);
...
SHERPA_ONNX_API const SherpaOnnxWave *SherpaOnnxReadWaveFromMem(
    const char *buffer, size_t size);

SHERPA_ONNX_API size_t SherpaOnnxWaveBufferSize(int32_t n_samples);
...
SHERPA_ONNX_API void SherpaOnnxClustering(int32_t num_clusters, float threshold,
                                          float *features, int32_t num_rows,
                                          int32_t num_cols, int32_t *labels);
